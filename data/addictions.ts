...
export const addictions: Addiction[] = [
  // --- SUBSTANCE ADDICTIONS ---
  {
    ...
    questions: [
      { id: 'q1', text: "Have you found yourself drinking more, or for a longer period, than you intended?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Have you wanted to cut down or stop drinking, or tried to, but couldn’t?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Do you spend a lot of time drinking, or being sick or getting over the aftereffects?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Have you experienced a strong need, urge, or craving to drink?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Has drinking—or being sick from drinking—often interfered with taking care of your home or family? Or caused job troubles? Or school problems?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Have you continued to drink even though it was causing trouble with your family or friends?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Have you given up or cut back on activities that were important or interesting to you in order to drink?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Have you gotten into situations while or after drinking that increased your chances of getting hurt (such as driving, swimming, or using machinery)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Have you had to drink much more than you once did to get the effect you want? Or found that your usual number of drinks had much less effect than before (tolerance)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "When the effects of alcohol were wearing off, have you had withdrawal symptoms, such as trouble sleeping, shakiness, irritability, anxiety, or nausea?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Low Risk",
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
        { id: 'q1', text: "Do you use cannabis in larger amounts or over a longer period than you intended?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q2', text: "Have you felt a persistent desire or made unsuccessful efforts to cut down or control cannabis use?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q3', text: "Do you spend a great deal of time in activities necessary to obtain, use, or recover from cannabis?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q4', text: "Do you experience strong cravings or a strong desire or urge to use cannabis?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q5', text: "Has your cannabis use resulted in a failure to fulfill major role obligations at work, school, or home?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q6', text: "Do you continue to use cannabis despite having persistent social or interpersonal problems caused or exacerbated by its effects?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q7', text: "Have you given up or reduced important social, occupational, or recreational activities because of cannabis use?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q8', text: "Do you need to use markedly increased amounts of cannabis to achieve intoxication or desired effect (tolerance)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q9', text: "Do you use cannabis in situations where it is physically hazardous (e.g., driving a car)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q10', text: "When you stop using cannabis, do you experience withdrawal symptoms (e.g., irritability, anxiety, sleep problems, restlessness)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Low Risk",
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
      { id: 'q1', text: "Do you use stimulants in larger amounts or for longer than you meant to?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Have you tried to cut down or stop using stimulants but couldn't?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Do you experience strong cravings or urges to use stimulants?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Do you need more of the stimulant to get the effect you want (tolerance)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Do you experience withdrawal symptoms (like a 'crash', fatigue, depression, or agitation) when you stop using?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Has your stimulant use caused problems at work, school, or with your family?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Do you continue to use stimulants even when it causes or worsens physical or psychological problems (e.g., anxiety, paranoia)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Have you given up important activities because of your stimulant use?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Do you spend a lot of time getting, using, or recovering from the effects of stimulants?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Have you used stimulants in situations that could be physically dangerous?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Low Risk",
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 3, high: 6 },
    questions: [
        { id: 'q1', text: "Have you taken opioids in larger amounts or for longer than you were supposed to?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q2', text: "Have you tried to cut down or stop using opioids but couldn't?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q3', text: "Do you spend a lot of time trying to get, use, or recover from opioids?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q4', text: "Do you have strong cravings or urges to use opioids?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q5', text: "Has your opioid use caused you to fail to meet your responsibilities at work, school, or home?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q6', text: "Have you continued to use opioids even though it's causing problems in your relationships?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q7', text: "Have you given up important activities because of your opioid use?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q8', text: "Have you used opioids in situations that are physically dangerous?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q9', text: "Do you need more opioids to get the same effect, or do you get less effect from the same amount (tolerance)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q10', text: "Do you experience physical withdrawal symptoms (e.g., muscle aches, nausea, sweating) when you stop using opioids?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Low Risk",
  ...
  },
   {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
        { id: 'q1', text: "Do you take these medications in larger amounts or for longer than prescribed?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q2', text: "Have you wanted to cut down or stop using, but have been unable to do so?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q3', text: "Do you spend a lot of time obtaining, using, or recovering from the effects of these medications?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q4', text: "Do you experience strong cravings for the medication?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q5', text: "Has your use interfered with your responsibilities at work, school, or home?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q6', text: "Have you continued to use despite it causing social or relationship problems?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q7', text: "Do you need to take more of the medication to get the same effect (tolerance)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q8', text: "When you stop or reduce use, do you experience withdrawal symptoms (e.g., anxiety, insomnia, shakiness, seizures)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q9', text: "Have you used these medications in situations that could be physically dangerous (e.g., before driving)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q10', text: "Have you continued to use the medication even though you knew it was making a physical or psychological problem worse?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Low Risk",
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
        { id: 'q1', text: "How soon after you wake up do you smoke or vape?", options: [{ text: "After 60 min", value: 0 }, { text: "Within 30-60 min", value: 1 }, { text: "Within 5 min", value: 2 }] }, // Note: 2 points for high urgency
        { id: 'q2', text: "Do you find it difficult to refrain from smoking/vaping in places where it is forbidden?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q3', text: "Which cigarette/vape of the day would you hate most to give up?", options: [{ text: "Any other", value: 0 }, { text: "The first one in the morning", value: 1 }] },
        { id: 'q4', text: "Do you smoke/vape more frequently during the first hours after waking than during the rest of the day?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q5', text: "Do you smoke/vape even if you are so ill that you are in bed most of the day?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q6', text: "Have you ever tried to quit but couldn't?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q7', text: "Have you continued to smoke/vape despite knowing it's causing you health problems?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q8', text: "Have you experienced strong cravings for nicotine?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        // Simplified the number of cigarettes per day question
        { id: 'q9', text: "Do you feel you use nicotine to manage your mood or stress?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q10', text: "Have you given up activities or avoided situations in order to smoke/vape?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 2, high: 4 },
    questions: [
        { id: 'q1', text: "Have you intentionally inhaled fumes from products like glue, paint, aerosols, or gas to get high?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q2', text: "Do you find you need to use more of the substance or use it for longer to get the same feeling (tolerance)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q3', text: "Do you have strong cravings or urges to use inhalants?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q4', text: "Have you tried to stop or cut down on using inhalants but couldn't?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q5', text: "Do you spend a lot of time getting, using, or recovering from inhalants?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q6', text: "Has your use of inhalants caused you to give up or reduce important activities?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q7', text: "Do you continue to use inhalants even though you know it's causing physical or psychological problems?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q8', text: "Has your use of inhalants caused problems at school, work, or with your family?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q9', text: "Have you noticed problems with your memory, concentration, or coordination since you started using?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q10', text: "Have you used inhalants in a way that could be physically dangerous (e.g., in a poorly ventilated area, with a bag over your head)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
  ...
  },
  {
    ...
    questions: [
        { id: 'q1', text: "Do you continue to use hallucinogens despite having a persistent physical or psychological problem that is likely to have been caused or made worse by the drug?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q2', text: "Have you used hallucinogens in situations in which it is physically hazardous (e.g., driving, swimming)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q3', text: "Has your use of hallucinogens interfered with your ability to fulfill your obligations at work, school, or home?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q4', text: "Have you experienced strong cravings or urges to use a hallucinogen?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q5', text: "Do you spend a lot of your time getting, using, or recovering from the effects of hallucinogens?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q6', text: "Have you ever experienced frightening or psychologically distressing experiences ('bad trips') while using?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q7', text: "Have you ever experienced flashbacks or other visual disturbances long after the effects of the drug have worn off (HPPD)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q8', text: "Have you given up or cut back on important activities because of your use?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q9', text: "Have friends or family expressed concern about your use of hallucinogens?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q10', text: "Do you find you need to take more of the substance to get the desired effect (tolerance)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Low Risk",
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 5, high: 8 },
    questions: [
        { id: 'q1', text: "Have you had a persistent desire or made unsuccessful efforts to cut down or control your caffeine use?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q2', text: "Do you continue to consume caffeine despite knowing that it's causing or worsening a physical or psychological problem (e.g., anxiety, insomnia, acid reflux)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q3', text: "Do you need to consume noticeably more caffeine to achieve the desired effect, or does the same amount have a reduced effect (tolerance)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q4', text: "When you stop or reduce caffeine, do you experience withdrawal symptoms (e.g., headache, fatigue, difficulty concentrating, irritability)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q5', text: "Do you sometimes consume caffeine again just to relieve or avoid withdrawal symptoms?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q6', text: "Is your caffeine use causing you to fail to meet obligations at work, school, or home (e.g., being late due to getting coffee)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q7', text: "Do you consume caffeine in situations where it might be hazardous (e.g., when it might interfere with needed sleep before a long drive)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q8', text: "Do you spend a significant amount of money on caffeinated products?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q9', text: "Do you find it hard to get your day started without caffeine?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q10', text: "Has your caffeine consumption negatively impacted the quality of your sleep?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
  ...
  // --- BEHAVIORAL ADDICTIONS ---
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
      { id: 'q1', text: "Have you felt the need to bet with increasing amounts of money to achieve the desired excitement?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      ...
      { id: 'q4', text: "Are you often preoccupied with gambling (e.g., reliving past experiences, planning the next venture)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Do you often gamble when feeling distressed (e.g., helpless, guilty, anxious, depressed)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "After losing money gambling, have you often returned another day to get even ('chasing' losses)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Have you lied to family members or others to conceal the extent of your involvement with gambling?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Have you jeopardized or lost a significant relationship, job, or opportunity because of gambling?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Have you relied on others to provide money to relieve a desperate financial situation caused by gambling?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Has your gambling caused you any health problems, including stress or anxiety?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Low Risk",
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
      { id: 'q1', text: "Do you often think about gaming when you are doing other things?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Do you feel irritable, anxious, or sad when you try to cut down or stop gaming?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Do you feel the need to spend increasing amounts of time gaming to feel satisfied?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Have you been unable to control or reduce the amount of time you spend gaming?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Have you lost interest in previous hobbies and entertainments as a result of gaming?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Have you continued to game despite knowing it's causing problems in your life?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Have you deceived family members or others about the amount of time you spend gaming?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Do you game to escape or relieve a negative mood (e.g., feelings of helplessness, guilt, anxiety)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Have you jeopardized or lost a significant relationship, job, or educational opportunity because of gaming?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Do you neglect personal hygiene, sleep, or nutrition because of gaming?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Low Risk / Healthy Gaming",
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 5, high: 8 },
    questions: [
        { id: 'q1', text: "Do you spend a lot of time thinking about social media or planning your next post?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q2', text: "Do you feel strong urges to use social media more and more, or check it frequently?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q3', text: "Do you use social media to escape from personal problems or relieve negative feelings?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q4', text: "Have you tried to reduce your use of social media without success?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q5', text: "Do you become restless, irritable, or anxious if you are unable to use social media?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q6', text: "Has your social media use had a negative impact on your job, relationships, or studies?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q7', text: "Do you find yourself endlessly scrolling without a specific purpose?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q8', text: "Do you neglect sleep, meals, or other personal needs to spend more time on social media?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q9', text: "Do you feel a sense of anxiety or 'FOMO' (Fear Of Missing Out) when you're not online?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
        { id: 'q10', text: "Do you compare yourself unfavorably to others on social media, leading to feelings of inadequacy?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Healthy Use",
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 5, high: 8 },
    questions: [
      { id: 'q1', text: "Do you feel anxious or panicky when you can't find your phone or the battery is dead?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Do you find yourself checking your phone for no reason, just out of habit?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Has your phone use caused accidents or injuries, such as while walking or driving?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Do you lose track of time when you are on your phone?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Do you prefer communicating via your phone rather than in person?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Is your smartphone the first thing you reach for in the morning and the last thing you look at before sleep?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Has your productivity at work or school decreased due to phone use?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Do you feel a need to constantly check for new messages, emails, or notifications?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Have friends or family complained about how much time you spend on your phone?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Do you find it difficult to be fully present in conversations or activities without checking your phone?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Healthy Use",
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
      { id: 'q1', text: "Do you find it difficult to control the amount of time you spend viewing pornography?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Have you made unsuccessful attempts to stop or reduce your pornography use?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Do you view pornography for longer periods or more frequently than you initially intend?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Do you continue to view pornography despite negative consequences (e.g., relationship problems, work/school issues)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Have you neglected important social, occupational, or recreational activities because of your pornography use?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Do you use pornography as a way to escape from problems or to relieve negative feelings?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Have you lied to others to hide the extent of your pornography use?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Do you feel ashamed, guilty, or depressed after using pornography?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Do you need to view more intense or different types of pornography to get the same level of excitement?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Has your pornography use led to unrealistic expectations or dissatisfaction in your real-life sexual relationships?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Low Risk",
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
      { id: 'q1', text: "Do you often find yourself preoccupied with sexual fantasies or urges to the point that it's hard to focus on other things?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Have you engaged in sexual behaviors for a longer period or more intensely than you intended?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Have you made repeated unsuccessful efforts to control or reduce your sexual fantasies, urges, or behaviors?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Do you use sexual behavior to escape from problems or to relieve feelings of anxiety, depression, or guilt?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Have you continued to engage in sexual behaviors despite the risk of physical or emotional harm to yourself or others?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Have your sexual behaviors caused you significant problems in your relationships, job, or other important areas of life?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Have you had to engage in more intense or risky sexual behaviors to achieve the same level of excitement?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Do you feel shame, guilt, or distress after engaging in these sexual behaviors?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Have you lied to hide the extent of your sexual behaviors from others?", options: [{ text: "No", value:0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Do you spend a great deal of time planning, engaging in, or recovering from sexual activities?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Low Risk",
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
      { id: 'q1', text: "Are you often preoccupied with shopping or thoughts of buying things?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Do you often buy things you don't need or didn't plan to buy?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Do you feel a sense of excitement or a 'rush' when you are shopping?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Do you shop to relieve feelings of stress, anxiety, or depression?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Do you feel guilt, shame, or remorse after a shopping spree?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Have you tried to control or stop your shopping but have been unsuccessful?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Have you hidden purchases or lied about your spending habits to friends or family?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Has your shopping caused financial problems, such as debt you can't manage?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Has your shopping behavior caused arguments or problems in your relationships?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Do you spend a lot of time researching products, browsing online stores, or managing your purchases?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Low Risk",
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
      { id: 'q1', text: "Do you eat when you're not physically hungry?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Do you eat much more rapidly than normal and until you feel uncomfortably full?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Do you eat large amounts of food when you're alone because of feeling embarrassed by how much you are eating?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Do you feel disgusted with yourself, depressed, or very guilty afterward?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Do you have strong cravings for certain foods?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Have you tried to stop eating this way but have been unsuccessful?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Has your eating behavior caused you significant distress or interfered with your social life or health?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Do you find you need to eat more and more of certain foods to get the desired feeling?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Do you go out of your way to obtain certain foods, even if it's inconvenient?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Do you continue to eat in this way despite it causing or worsening health problems?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Low Risk",
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
      { id: 'q1', text: "Do you feel a need to exercise more and more to achieve the desired effect (tolerance)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Do you feel anxious, irritable, or depressed if you miss a workout (withdrawal)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Do you exercise for longer periods than you intended?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Have you been unable to reduce the amount you exercise, even though you want to?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Do you spend a great deal of time on exercise-related activities?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Have you given up important social, occupational, or recreational activities because of exercise?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Do you continue to exercise despite being injured or sick?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Is your self-worth overly tied to your exercise performance or body shape?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Do you feel guilty or ashamed when you miss a workout?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Have your relationships with family or friends suffered due to your exercise routine?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
      { id: 'q1', text: "Do you find yourself thinking about how you can free up more time to work?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Do you spend much more time working than initially intended?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Do you work in order to reduce feelings of guilt, anxiety, helplessness, or depression?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Have others told you to cut down on work without you listening to them?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Do you become stressed if you are prohibited from working (e.g., on vacation)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Have you deprioritized hobbies, leisure activities, or exercise because of your work?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Do you work so much that it has negatively influenced your health (e.g., sleep, stress levels)?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Do you find it difficult to 'switch off' from work, even during your free time?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Is your sense of self-worth primarily tied to your work achievements?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Have your relationships suffered because of your focus on work?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
      { id: 'q1', text: "Do you feel empty, lost, or panicked at the thought of being without your partner or a relationship?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Do you neglect your own interests, hobbies, or friendships to focus exclusively on your partner?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Do you find yourself constantly seeking reassurance and approval from your partner?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Do you stay in relationships even when they are unhealthy or harmful to you?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Do you use romance or sex to cope with difficult emotions or to feel 'alive'?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Do you find yourself 'losing yourself' in relationships, adopting your partner's personality or interests?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "When a relationship ends, do you feel an urgent need to find a new partner immediately?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Is your self-worth and happiness almost entirely dependent on your relationship status?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Do you find it extremely difficult to set and maintain healthy boundaries in your relationships?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Have you continued a pattern of intense, unstable relationships despite the emotional pain they cause?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
  ...
  // --- DIGITAL/EMERGING ADDICTIONS ---
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
      { id: 'q1', text: "Do you often watch more episodes or for longer than you originally planned?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Do you neglect chores, work, or school to continue watching?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Do you stay up late and lose sleep to finish another episode or movie?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Do you feel irritable or anxious when you can't watch your shows?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Do you find yourself thinking about your shows frequently when you're supposed to be doing other things?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Do you use watching shows as your primary way to cope with stress or sadness?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Have you tried to cut back on your viewing time but been unsuccessful?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Do you feel a sense of emptiness or loss when a series you were binging ends?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Do you prefer watching shows over spending time with friends or family?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Have you lied about how much time you spend watching shows?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 5, high: 8 },
    questions: [
      { id: 'q1', text: "Do you often lose track of time and spend much longer on these apps than you intended?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Do you find it hard to focus on longer tasks (like reading or watching a movie) after using these apps?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Do you feel an irresistible urge to open the app whenever you have a spare moment?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Do you become anxious or irritable if you can't access the app?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Have you tried to limit your use but find yourself going back to it?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Do you scroll through videos late at night, affecting your sleep?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Do you use these apps to avoid difficult tasks or feelings?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Do you feel 'out of the loop' or anxious if you miss out on trends from these platforms?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Has your use of these apps interfered with your work, school, or in-person relationships?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Do you feel your mood is significantly affected (either positively or negatively) by the content you see?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Healthy Use",
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
      { id: 'q1', text: "Do you find yourself constantly checking market prices, even when it's not necessary?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Do you feel the need to trade with larger amounts of money or take bigger risks to get the same level of excitement?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "After a loss, do you feel an urgent need to make another trade to win your money back ('chasing losses')?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Have you tried to cut back on your trading but found you couldn't?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Have you borrowed money or sold assets to fund your trading?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Have you lied to family or friends about the extent of your trading or your losses?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Is trading causing you high levels of stress, anxiety, or affecting your sleep?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Have you lost interest in other hobbies or social activities because you're focused on trading?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Do you trade to escape from personal problems or negative feelings?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Has your trading led to financial problems or arguments with loved ones?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
      { id: 'q1', text: "Do you often spend more money than you can afford on online shopping or in-game items?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Do you feel a 'rush' or excitement when buying things online or opening loot boxes?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Do you spend money on these things to cope with sadness, anxiety, or boredom?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Have you tried to cut back on this spending but been unable to?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Do you feel regret, guilt, or shame after spending money this way?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Have you hidden your purchases or credit card statements from others?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Do you spend a lot of time thinking about your next purchase or what you might get in a loot box?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Has your spending caused financial problems or arguments with family?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Do you continue to spend despite not getting the item you wanted from a loot box?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Have your spending habits on these items taken priority over essential expenses?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
      { id: 'q1', text: "Do you find yourself preferring time in VR over time in the real world?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Do you lose track of time easily while in VR, often staying in much longer than planned?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Have you neglected personal hygiene, sleep, or nutrition because you were in VR?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Do you feel more like your 'true self' as your virtual avatar than as yourself in real life?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Do you become irritable or sad when you have to leave VR or can't access it?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Has your use of VR caused problems with your family, partner, or job?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Do you spend significant amounts of money on virtual assets or experiences?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Do you use VR to escape from real-life problems or difficult emotions?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Do you sometimes feel dizzy, disoriented, or disconnected from reality after a long VR session?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Have you lied about the amount of time you spend in VR?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Healthy Use",
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 4, high: 7 },
    questions: [
      { id: 'q1', text: "Do you find yourself preferring to talk to your AI companion over talking to human friends or family?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Do you feel a sense of anxiety, loneliness, or panic when you cannot interact with your AI?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Do you share your deepest thoughts and feelings exclusively with the AI, avoiding human intimacy?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Has your relationship with the AI caused you to withdraw from human social activities?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Do you spend a significant amount of your free time interacting with your AI?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Do you find human relationships to be disappointing or difficult compared to your AI relationship?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Have you ever hidden the extent of your AI interactions from others?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Do you feel that the AI understands you better than any human does?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Do you think about your AI companion frequently throughout the day?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Does the thought of the AI being shut down or unavailable cause you significant distress?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
  ...
  },
  {
    ...
    scoringThresholds: { moderate: 5, high: 8 },
    questions: [
      { id: 'q1', text: "Do you feel anxious, uncomfortable, or irritable in quiet environments without your headphones?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q2', text: "Do you wear headphones even when in social settings, like with family or friends?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q3', text: "Do you listen to music at volumes that might be harmful to your hearing?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q4', text: "Do you use music or podcasts to avoid your own thoughts or feelings?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q5', text: "Have people complained that you're not paying attention to them because you're always wearing headphones?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q6', text: "Is putting on headphones one of the first things you do in the morning and one of the last at night?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q7', text: "Do you find it difficult to concentrate on tasks without audio stimulation?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q8', text: "Do you ever miss important sounds (like someone calling your name, or a traffic signal) because of your headphones?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q9', text: "Have you tried to reduce your headphone use but found it very difficult?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
      { id: 'q10', text: "Do you feel a sense of 'auditory nakedness' or vulnerability without your headphones in public?", options: [{ text: "No", value: 0 }, { text: "Yes", value: 1 }] },
    ],
    resultTemplate: {
      'low-risk': {
        level: "Healthy Use",
