...
const DiaryDetailPage: React.FC = () => {
    ...
    const { getItemById: getEntryById } = useUserCollection();
    ...
    useEffect(() => {
        if (entryId) {
            ...
            if (foundEntry) {
                ...
                navigate('/collection'); // Redirect if not found
            }
        }
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="flex justify-between items-center mb-6">
                ...
                {/* This page seems to be a work-in-progress, linking to a non-existent route. */}
                {/* <Link
            ...
            <div className="bg-brand-surface p-6 sm:p-8 rounded-lg shadow-lg">
                ...
                <p className="text-sm text-brand-text-muted mb-6">
                    {/* FIX: The 'modified' property was renamed to 'dateSaved'. */}
                    Last modified: {new Date(entry.dateSaved).toLocaleString()}
                </p>
                <div
