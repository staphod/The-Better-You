...
import { NetworkIcon, AtomIcon } from '@/components/icons/ModuleIcons';
    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-left mb-8">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-bold text-brand-text-primary">Mental Models</h1>
        </div>
      ...
      <div className="space-y-4">
        ...
        {/* Future mental models will be added here */}
      </div>
    </div>
  );
};
