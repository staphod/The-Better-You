  ...
  return (
    <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="mt-8 bg-brand-surface p-8 rounded-lg shadow-lg">
            <OneLineIcon className="h-16 w-16 text-brand-accent mx-auto mb-4" />
            <h1 className="text-3xl font-bold text-brand-text">One-Line Drawing Puzzle</h1>
            <p className="mt-4 text-xl text-brand-text-muted">
                Coming Soon!
            </p>
            <p className="mt-2 text-brand-text-muted">
               This intricate puzzle of focus and planning is currently under development. Prepare to test your tracing skills!
            </p>
        </div>
    </div>
  );
