...
const MentalModelsPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center h-full max-w-md mx-auto">
        <NetworkIcon className="h-24 w-24 text-brand-accent mb-6" />
        <h1 className="text-4xl font-bold text-brand-text-primary">Mental Models</h1>
        <p className="mt-4 text-lg text-brand-text-secondary">
            This module is under construction. Explore a library of powerful mental models to improve your thinking and understanding of the world.
        </p>
